...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ajouter_video
        if ($pathinfo === '/accueil/video/ajouter-une-video') {
            return array (  '_controller' => 'LBcrew\\MediaBundle\\Controller\\VideoController::ajouterAction',  '_route' => 'ajouter_video',);
        }
        ...
        // lb_crew_accueil
        if ($pathinfo === '/accueil-lb-crew') {
            return array (  '_controller' => 'LBcrew\\SiteBundle\\Controller\\SiteController::indexAction',  '_route' => 'lb_crew_accueil',);
        }
