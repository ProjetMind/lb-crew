 ...
 */
class commentaires extends \LBcrew\MediaBundle\Entity\commentaires implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDatePubCom($datePubCom);
    }

    public function getDatePubCom()
    {
        $this->__load();
        return parent::getDatePubCom();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'commentaire', 'date_pub_com', 'media');
    }
