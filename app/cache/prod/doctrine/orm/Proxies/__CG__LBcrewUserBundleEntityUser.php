 ...
 */
class User extends \LBcrew\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addStatut(\LBcrew\UserBundle\Entity\statut $statuts)
    {
        $this->__load();
        return parent::addStatut($statuts);
    }

    public function removeStatut(\LBcrew\UserBundle\Entity\statut $statuts)
    {
        $this->__load();
    ...
    public function setAvatar(\LBcrew\UserBundle\Entity\avatar $avatar = NULL)
    {
        $this->__load();
    ...
    public function addMessage(\LBcrew\MessagesBundle\Entity\message $message)
    {
        $this->__load();
        return parent::addMessage($message);
    }

    public function removeMessage(\LBcrew\MessagesBundle\Entity\message $message)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'usernom', 'userprenom', 'statuts', 'avatar', 'message');
    }
